...
import ProductsSection from "./Shop";
        ...
        <div className="row">
          <div className="col-md-12">
            <p className="breadcrumbs">
              ...
              <span style={{ color: 'white' }}>Product Single</span>
            </p>
            <h1 className="mb-0 bread" style={{ fontSize: '48px', fontWeight: 'bold', color: '#fff' }}>Product Single</h1>
          </div>
        </div>
      </div>
    </div>
